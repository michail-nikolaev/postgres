...
run_scenario(
	'moving_identity_sub',
	{
		...
		# AccessExclusiveLock, and with an apply worker writing the table
		# continuously alongside twenty pgbench clients the bounded helper
		# never finds a gap -- the identity_moved check reports that
