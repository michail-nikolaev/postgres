			   ...
			   IndexBulkDeleteCallback callback, void *callback_state)
{
	 ...
	 * accepts invalidation messages, and an invalidation for this index
	 * pfrees rd_amcache -- after which both cachedmetap here and the copy
	 * the read stream callback holds would be dangling, and
	 * BUCKET_TO_BLKNO() would compute a block number out of freed memory.
	 */
