						...
						TupleTableSlot **localslot)
{
	...
	*localslot = table_slot_create(localrel, &estate->es_tupleTable);
	...
	/*
	 * The index this apply will search the relation by has been chosen but
	 * not used yet, which is the window a concurrent rebuild of it gets
	 * into.
	 */
	INJECTION_POINT("apply-before-find-repl-tuple", NULL);
