...
extern int	VacuumTruncateLockCheckInterval;
extern int	VacuumTruncateLockWaitInterval;
extern int	VacuumTruncateLockTimeout;
extern int	VacuumTruncateMaxPagesPerLock;
